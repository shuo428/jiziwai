...
import { User, Lock, UserPlus, Cpu } from 'lucide-react';
                ...
                <div className="relative z-10 max-w-md mx-auto">
                    ...
                    <div className="space-y-4">
                        ...
                        <p className="text-slate-600 text-base leading-relaxed">
                            创建账号，体验集成AI助手和JNI桥接控制的物理实验数据处理系统
                        </p>
                ...
                <div className="w-full max-w-md">
                    <Card className="bg-white/80 backdrop-blur-xl border border-white/60 shadow-2xl rounded-2xl p-8">
                        <div className="text-center mb-8">
                            <Title level={2} className="!mb-2 !text-slate-800 !font-bold">创建账号</Title>
                            <Text className="text-slate-500 text-base">填写信息以开始使用系统</Text>
                        </div>
                        ...
                        >
                            ...
                            <Form.Item
                                label={<span className="text-slate-700 font-semibold text-sm">确认密码</span>}
